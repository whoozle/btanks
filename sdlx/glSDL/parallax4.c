...
int main(int argc, char* argv[])
{
	...
	if(alpha)
		SDL_SetAlpha(tiles_bmp, SDL_SRCALPHA|SDL_RLEACCEL, alpha);
	otiles = SDL_DisplayFormat(tiles_bmp);
	/* Set colorkey for non-opaque tiles to bright magenta */
	SDL_SetColorKey(tiles_bmp, SDL_SRCCOLORKEY|SDL_RLEACCEL,
			SDL_MapRGB(tiles_bmp->format,255,0,255));
